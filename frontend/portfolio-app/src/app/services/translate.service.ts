...
export class TranslateService {
  ...
  translations: { en: Translations; ur: Translations } = {
    en: {
      ...
      'nav.contact': 'Contact',
      'hero.title': 'MoazAli',
      'hero.subtitle': 'Software Developer & Student',
      'hero.education': 'Riphah International University (2022–2026)',
      'hero.hire': 'Hire Me',
      'hero.resume': 'View Resume',
      'hero.contact': 'Contact',
      'about.title': 'About Me',
      'about.description': 'I am a passionate software developer and student at Riphah International University, pursuing my degree from 2022 to 2026. I love creating innovative solutions and learning new technologies.',
      'skills.title': 'Skills',
      ...
      'footer.copyright': '© 2024 MoazAli. All rights reserved.',
      'auth.login': 'Login',
      'auth.signup': 'Sign Up',
      'auth.logout': 'Logout',
      'auth.email': 'Email',
