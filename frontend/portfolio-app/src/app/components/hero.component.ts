...
@Component({
  ...
  template: `
    <section id="hero" class="min-h-screen flex items-center justify-center px-4 pt-20 pb-12 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div class="container mx-auto max-w-6xl">
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="animate-fade-in-up">
            <div class="w-48 h-48 mx-auto md:mx-0 mb-8 rounded-full bg-gradient-to-br from-indigo-400 to-purple-600 p-1 shadow-2xl">
              <div class="w-full h-full rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-6xl font-bold text-indigo-600 dark:text-indigo-400">
                MA
              </div>
            </div>
            ...
            <div class="flex gap-4">
              <a href="https://github.com/Moazali302" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.linkedin.com/in/moaz-ali-4710ba397/" target="_blank" rel="noopener noreferrer"
                 class="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="animate-fade-in-up hidden md:block">
            <div class="relative">
              <div class="absolute inset-0 bg-gradient-to-r from-indigo-400 to-purple-600 rounded-3xl transform rotate-6 opacity-20"></div>
              <div class="relative bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl">
                <h3 class="text-xl font-bold mb-4 text-slate-800 dark:text-slate-200">Quick Stats</h3>
                <div class="space-y-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold text-slate-800 dark:text-slate-200">JavaScript Expert</p>
                      <p class="text-sm text-slate-600 dark:text-slate-400">Frontend & Backend</p>
                    </div>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white font-bold">
                      AN
                    </div>
                    <div>
                      <p class="font-semibold text-slate-800 dark:text-slate-200">Angular Developer</p>
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold text-slate-800 dark:text-slate-200">Node.js Developer</p>
