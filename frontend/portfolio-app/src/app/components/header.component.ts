  ...
  template: `
    <header class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
      <nav class="container mx-auto px-4 py-4 flex items-center justify-between">
        <a routerLink="/" class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
          MoazAli
        </a>
        
        <div class="hidden md:flex items-center gap-6">
          <a routerLink="/" fragment="hero" routerLinkActive="text-indigo-600 dark:text-indigo-400" 
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            {{ translate.translate('nav.home') }}
          </a>
          <a routerLink="/" fragment="about" routerLinkActive="text-indigo-600 dark:text-indigo-400"
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            {{ translate.translate('nav.about') }}
          </a>
          <a routerLink="/" fragment="skills" routerLinkActive="text-indigo-600 dark:text-indigo-400"
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            {{ translate.translate('nav.skills') }}
          </a>
          <a routerLink="/" fragment="projects" routerLinkActive="text-indigo-600 dark:text-indigo-400"
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            {{ translate.translate('nav.projects') }}
          </a>
          <a routerLink="/" fragment="blog" routerLinkActive="text-indigo-600 dark:text-indigo-400"
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            {{ translate.translate('nav.blog') }}
          </a>
          <a routerLink="/" fragment="contact" routerLinkActive="text-indigo-600 dark:text-indigo-400"
             class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
